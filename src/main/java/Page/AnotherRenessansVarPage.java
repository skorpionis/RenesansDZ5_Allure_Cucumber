...
public class AnotherRenessansVarPage extends BaseRenPage {
    ...
    private WebElement stavka = element.findElement(By
            .xpath("//SPAN[@class='js-calc-rate']"));
    private WebElement nachislenie = element.findElement(By
            .xpath("//SPAN[@class='js-calc-earned']"));
    private WebElement popolnenie = element.findElement(By
            .xpath("//SPAN[@class='js-calc-replenish']"));
    private WebElement sniatie = element.findElement(By
            .xpath("//SPAN[@class='js-calc-result']"));
